...
@Slf4j
public class DataSourceTypesDiscoveryAssetTypesArraysNameTest extends SampleTestCase {
    @Override
    public String getPropertyName() {
        return "/datasource_types/datasource_types/discovery/assetTypes/name";
    }
