...
@Slf4j
public class DataSourceTypesDiscoveryAssetTypesArraysLabelTest extends SampleTestCase {
    @Override
    public String getPropertyName() {
        return "/datasource_types/datasource_types/discovery/assetTypes/label";
    }
