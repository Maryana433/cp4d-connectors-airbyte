...
@Slf4j
public class DataSourceTypesActionsArraysPropertiesOutputTest extends SampleTestCase {
    @Override
    public String getPropertyName() {
        return "/datasource_types/datasource_types/actions/properties/output";
    }
