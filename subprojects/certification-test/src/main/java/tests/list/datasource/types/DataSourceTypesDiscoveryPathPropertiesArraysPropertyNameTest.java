...
@Slf4j
public class DataSourceTypesDiscoveryPathPropertiesArraysPropertyNameTest extends SampleTestCase {
    @Override
    public String getPropertyName() {
        return "/datasource_types/datasource_types/discovery/pathProperties/propertyName";
    }
