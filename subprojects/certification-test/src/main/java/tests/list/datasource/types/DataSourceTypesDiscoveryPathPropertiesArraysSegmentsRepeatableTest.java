...
@Slf4j
public class DataSourceTypesDiscoveryPathPropertiesArraysSegmentsRepeatableTest extends SampleTestCase {
    @Override
    public String getPropertyName() {
        return "/datasource_types/datasource_types/discovery/pathProperties/segments/repeatable";
    }
