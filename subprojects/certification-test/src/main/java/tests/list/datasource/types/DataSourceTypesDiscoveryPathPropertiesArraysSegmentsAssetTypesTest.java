...
@Slf4j
public class DataSourceTypesDiscoveryPathPropertiesArraysSegmentsAssetTypesTest extends SampleTestCase {
    @Override
    public String getPropertyName() {
        return "/datasource_types/datasource_types/discovery/pathProperties/segments/assetTypes";
    }
