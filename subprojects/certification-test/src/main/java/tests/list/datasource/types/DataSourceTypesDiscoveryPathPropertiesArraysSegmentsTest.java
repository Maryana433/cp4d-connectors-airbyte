...
@Slf4j
public class DataSourceTypesDiscoveryPathPropertiesArraysSegmentsTest extends SampleTestCase {
    @Override
    public String getPropertyName() {
        return "/datasource_types/datasource_types/discovery/pathProperties/segments";
    }
